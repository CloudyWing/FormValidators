...
public sealed class MobilePhoneValidator : FormValidatorBase {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="MobilePhoneValidator" /> class.
    /// </summary>
    /// <param name="column">The column.</param>
    /// <param name="value">The value.</param>
    /// <param name="customErrorMessageAccessor">The custom error message accessor. The arguments are column, value, mobile phone formats.</param>
